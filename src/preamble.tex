...
\setmathfont{XITS Math} % Type for math symbols
\setmathrm{XITS} % Math roman type
...
\newcommand{\acronym}[1]{\textsc{\fontspec[Numbers={OldStyle}]{Adobe Garamond Pro}\MakeLowercase{#1}}}
\newcommand{\uppersc}[1]{{\fontspec[Letters=UppercaseSmallCaps]{Adobe Garamond Pro}#1}}
